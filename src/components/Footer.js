      ...
      <footer className="footer_section">
        ...
        <div className="footer_container">
          ...
          <div id="icon_section">
            {/* instagram icon */}
            <a
              href="https://www.instagram.com/rgukt_rkv_cse?igsh=Z2Y1bTR6ODZwYmlv"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                className="social_icons instagram-icon"
              >
            ...
            {/* Linkedin icon */}
            <a
              href="https://www.linkedin.com/company/src-rgukt-rkvalley/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                className="social_icons linkedin-icon"
              >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                className="social_icons github-icon"
              >
